...
- [ ] 2. Implementar DAT2Reader
  - [ ] 2.1 Criar módulo dat2_reader.py com parsing de header e índice
    ...
    - _Requirements: 1.1_
  - [ ] 2.2 Escrever property test para listagem de arquivos DAT2
    - **Property 1: DAT2 File Listing Completeness**
    - **Validates: Requirements 1.1**
  - [ ] 2.3 Implementar extração e descompressão de arquivos
    - Implementar método `extract_file(path)` com descompressão zlib
    - Implementar tratamento de arquivos não comprimidos
    - _Requirements: 1.2_
  - [ ] 2.4 Escrever property test para round-trip de extração
    - **Property 2: DAT2 Extraction Round-Trip**
    - **Validates: Requirements 1.2**
  - [ ] 2.5 Implementar sistema de prioridade multi-DAT
    ...
    - _Requirements: 1.4_
  - [ ] 2.6 Escrever property test para resolução de prioridade
    - **Property 3: DAT2 Priority Resolution**
    - **Validates: Requirements 1.4**

- [ ] 3. Checkpoint - Verificar testes DAT2
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 4. Implementar PaletteLoader e FRMDecoder
  - [ ] 4.1 Criar módulo palette_loader.py
    ...
    - _Requirements: 2.1_
  - [ ] 4.2 Criar módulo frm_decoder.py com parsing de header FRM
  ...
  - [ ] 4.3 Implementar conversão FRM para PNG
  ...
  - [ ] 4.4 Escrever property test para preservação de transparência
    - **Property 7: Transparency Preservation**
    - **Validates: Requirements 2.4**
  - [ ] 4.5 Implementar exportação multi-direção
    - Gerar arquivos separados com sufixos (_ne, _e, _se, _sw, _w, _nw)
    - Implementar método `export_all_directions()`
    - _Requirements: 2.2_
  - [ ] 4.6 Escrever property test para completude de direções
    - **Property 5: FRM Direction Export Completeness**
    - **Validates: Requirements 2.2**
  - [ ] 4.7 Implementar exportação de animações (spritesheet/frames)
    - Implementar método `to_spritesheet()` para múltiplos frames
    - Implementar método `to_individual_frames()` alternativo
    - _Requirements: 2.3_
  - [ ] 4.8 Escrever property test para exportação de frames
    - **Property 6: FRM Animation Frame Export**
    - **Validates: Requirements 2.3**
  - [ ] 4.9 Escrever property test para round-trip FRM-PNG
    - **Property 4: FRM to PNG Round-Trip**
    - **Validates: Requirements 2.1, 2.5**

- [ ] 5. Checkpoint - Verificar testes FRM
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 6. Implementar Extração de Criaturas
  - [ ] 6.1 Criar módulo critter_extractor.py
  ...
  - [ ] 6.2 Escrever property test para completude de animações
    - **Property 8: Critter Animation Completeness**
    - **Validates: Requirements 3.2**
  - [ ] 6.3 Implementar preservação de metadados de offset
    - Gerar arquivo JSON com offset_x, offset_y para cada sprite
    - Incluir informações de fps e frame count
    - _Requirements: 3.3_
  - [ ] 6.4 Escrever property test para metadados de offset
    - **Property 9: Sprite Offset Metadata Preservation**
    - **Validates: Requirements 3.3**

- [ ] 7. Implementar Extração de Tiles
  - [ ] 7.1 Criar módulo tile_extractor.py
  ...
  - [ ] 7.2 Escrever property test para dimensões de tiles
    - **Property 10: Isometric Tile Dimensions**
    - **Validates: Requirements 4.3**

- [ ] 8. Implementar Extração de Interface
  - [ ] 8.1 Criar módulo ui_extractor.py
...
- [ ] 9. Checkpoint - Verificar extração de sprites
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 10. Implementar ACMDecoder (Áudio)
  - [ ] 10.1 Criar módulo acm_decoder.py
    ...
    - _Requirements: 6.1_
  - [ ] 10.2 Escrever property test para conversão de áudio
    - **Property 11: Audio Format Conversion**
    - **Validates: Requirements 6.1**
  - [ ] 10.3 Implementar organização de áudio
    - Organizar em pastas: music/, sfx/, voice/
    - Implementar detecção automática de tipo por caminho original
    - _Requirements: 6.2_

- [ ] 11. Implementar MAPParser
  - [ ] 11.1 Criar módulo map_parser.py
    ...
    - _Requirements: 7.1_
  - [ ] 11.2 Implementar exportação JSON de mapas
    - Exportar estrutura completa em JSON legível
    - Incluir referências a scripts associados
    - _Requirements: 7.2, 7.3_
  - [ ] 11.3 Escrever property test para completude de dados de mapa
    - **Property 12: MAP Data Completeness**
    - **Validates: Requirements 7.1, 7.2, 7.3**

- [ ] 12. Implementar MSGParser
  - [ ] 12.1 Criar módulo msg_parser.py
    ...
    - _Requirements: 8.1_
  - [ ] 12.2 Implementar exportação JSON de mensagens
    - Exportar como {id: texto} em JSON
    - Organizar por locale quando aplicável
    - _Requirements: 8.2, 8.3_
  - [ ] 12.3 Escrever property test para round-trip de MSG
    - **Property 13: MSG Parsing Round-Trip**
    - **Validates: Requirements 8.1, 8.2**

- [ ] 13. Checkpoint - Verificar parsers de dados
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 14. Implementar AssetOrganizer e Manifesto
  - [ ] 14.1 Criar módulo asset_organizer.py
    - Implementar organização automática na estrutura Godot
    - Criar subpastas: sprites/{categoria}/, audio/{tipo}/, data/{tipo}/
    - _Requirements: 10.1, 10.2, 10.3, 10.4_
  - [ ] 14.2 Escrever property test para conformidade de estrutura
    - **Property 15: Output Structure Conformance**
    - **Validates: Requirements 10.1, 10.2, 10.3, 10.4**
  - [ ] 14.3 Implementar geração de manifesto
  ...
  - [ ] 14.5 Implementar logging de erros
    - Criar arquivo de log separado para erros
    - Incluir timestamp, arquivo, tipo de erro, mensagem
    - _Requirements: 9.3_

- [ ] 15. Implementar ExtractionPipeline
  - [ ] 15.1 Criar módulo extraction_pipeline.py
  ...
  - [ ] 15.2 Criar script CLI principal
...
- [ ] 16. Checkpoint Final - Verificar todos os testes
  - Ensure all tests pass, ask the user if questions arise.
