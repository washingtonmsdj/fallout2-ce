#!/usr/bin/env python3
"""
Script para corrigir especificamente o mapa ARVILLAG.MAP
"""
...
def fix_arvillag_map():
    """Corrige especificamente o mapa ARVILLAG."""
    ...
    print("Corrigindo mapa ARVILLAG...")
    ...
    try:
        ...
        # Parsear
        parsed = parse_map_definitivo(map_data, "arvillag.map", verbose=True)
...
Parsing concluído:")
        ...
        # Salvar
        output_file = output_path / "maps/Maps/ARVILLAG.json"
...
if __name__ == "__main__":
    success = fix_arvillag_map()
    if success:
        print("\n✅ Mapa ARVILLAG corrigido com sucesso!")
    else:
        print("\n❌ Falha ao corrigir mapa ARVILLAG")